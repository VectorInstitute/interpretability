...
from nam.model import NeuralAdditiveModel, ExULayer, ReLULayer
...
def train_and_predict(model: torch.nn.Module,
                      cfgs: dict,
                      train: DataLoader,
                      test: DataLoader,
                      val: DataLoader,
...
def main():
    ...
    train_dl, test_dl, val_dl = get_data_loaders(X, y, config['train_params']['batch_size'])
